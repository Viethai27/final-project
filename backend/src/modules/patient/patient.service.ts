...
import { mapPatient, resolvePatientForIntake, validatePatientInput, type IntakePatientInput } from './patient.intake';
...
export const createPatientRecord = async (input: IntakePatientInput) => {
